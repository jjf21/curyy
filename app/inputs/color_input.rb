class ColorInput < SimpleForm::Inputs::Base
  def input(wrapper_options)
    ...
    picker = tag.span(icon, class:"bg-blue-500 flex items-center px-2 rounded-l border border-r-0 transition", data: { color_picker_target: "picker_container", action: "click->color-picker#togglePalette" } )

    default_colors = ["#CBE4F9", "#CDF5F6", "#EFF9DA", "#FF8066", "#FFE5D9", "#005B8A", "#00C39A"]
    ...
    palette = tag.div(color_tags, class:"flex justify-evenly mt-2", data: { color_picker_target: "palette"})
